...
static const struct drm_ioctl_desc rknpu_ioctls[] = {
	...
	DRM_IOCTL_DEF_DRV(RKNPU_MEM_SYNC, rknpu_gem_sync_ioctl,
			  DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(RKNPU_GET_DRV_COMP_PERF_NUMS, rknpu_get_drv_comp_perf_eval_ioctl,
			  DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(RKNPU_CLEAR_DRV_COMP_PERF_NUMS, rknpu_clear_drv_comp_perf_eval_ioctl,
			  DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(RKNPU_SET_DRV_COMP_PERF_NUMS, rknpu_set_drv_comp_perf_eval_ioctl,
			  DRM_RENDER_ALLOW),
};
