...
/**
 * Used to evaluate NPU computation performance
 *
 * @cnt_limit: the number of rknpu jobs to measure
 * @cnt_total: NPU computation time added up until reaching cnt_limit
 *
 */
