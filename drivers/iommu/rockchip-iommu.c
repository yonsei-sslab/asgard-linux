...
EXPORT_SYMBOL_GPL(unprot_rockchip_pagefault_done);
...
EXPORT_SYMBOL_GPL(unprot_rockchip_get_iommu_base);
...
EXPORT_SYMBOL(unprot_rockchip_iommu_disable);
...
EXPORT_SYMBOL(unprot_rockchip_iommu_enable);
...
EXPORT_SYMBOL(unprot_rockchip_iommu_is_enabled);
