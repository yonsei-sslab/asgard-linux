...
#define ARM_SMCCC_KVM_FUNC_ATTACH_DEVICE	9
#define ARM_SMCCC_KVM_FUNC_DETACH_DEVICE	10
#define ARM_SMCCC_KVM_FUNC_GET_HYP_PERF_NUMS	11
...
/* Attach and detach VFIO device */
#define ARM_SMCCC_VENDOR_HYP_KVM_ATTACH_DEVICE_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_ATTACH_DEVICE)

#define ARM_SMCCC_VENDOR_HYP_KVM_DETACH_DEVICE_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_DETACH_DEVICE)

#define ARM_SMCCC_VENDOR_HYP_KVM_GET_HYP_PERF_NUMS_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_GET_HYP_PERF_NUMS)
