...
struct kvm_vcpu {
	...
	unsigned long hypcall_handle_start_time;
	unsigned long hypcall_handle_end_time;
...
struct kvm {
	...
	struct device *io_mem_dev;
	struct cdev io_mem_cdev;
	kvm_pfn_t *io_mem_pfns;
	int io_mem_id;
	int io_mem_npages;
};
...
int kvm_clear_vm_exit_count(void);
int kvm_get_gic_irq_perf_nums(unsigned long arg);
int kvm_clear_gic_irq_perf_nums(void);
