...
static bool pvm_access_pmu_evcntr(struct kvm_vcpu *vcpu,
				  struct sys_reg_params *p,
				  const struct sys_reg_desc *r)
{
	if (p->is_write) {
		/* Setting counter value is not supported yet */
		return false;
	} else {
		p->regval = read_sysreg(pmccntr_el0);
...
static const struct sys_reg_desc pvm_sys_reg_descs[] = {
	...
	HOST_HANDLED(SYS_PMINTENSET_EL1),
	HOST_HANDLED(SYS_PMINTENCLR_EL1),
	...
	/* Performance Monitoring Registers */
	HOST_HANDLED(SYS_PMCR_EL0),
	HOST_HANDLED(SYS_PMCNTENSET_EL0),
	HOST_HANDLED(SYS_PMCNTENCLR_EL0),
	HOST_HANDLED(SYS_PMOVSCLR_EL0),
	HOST_HANDLED(SYS_PMSWINC_EL0),
	HOST_HANDLED(SYS_PMSELR_EL0),
	HOST_HANDLED(SYS_PMCEID0_EL0),
	HOST_HANDLED(SYS_PMCEID1_EL0),
	{ SYS_DESC(SYS_PMCCNTR_EL0), .access = pvm_access_pmu_evcntr, },
	HOST_HANDLED(SYS_PMXEVTYPER_EL0),
	HOST_HANDLED(SYS_PMXEVCNTR_EL0),
	HOST_HANDLED(SYS_PMUSERENR_EL0),
	HOST_HANDLED(SYS_PMOVSSET_EL0),
	...
	/* Performance Monitoring Registers */
	/* PMEVCNTRn_EL0 */
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(0)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(1)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(2)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(3)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(4)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(5)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(6)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(7)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(8)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(9)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(10)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(11)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(12)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(13)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(14)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(15)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(16)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(17)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(18)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(19)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(20)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(21)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(22)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(23)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(24)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(25)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(26)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(27)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(28)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(29)),
	HOST_HANDLED(SYS_PMEVCNTRn_EL0(30)),
	/* PMEVTYPERn_EL0 */
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(0)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(1)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(2)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(3)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(4)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(5)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(6)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(7)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(8)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(9)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(10)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(11)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(12)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(13)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(14)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(15)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(16)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(17)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(18)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(19)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(20)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(21)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(22)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(23)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(24)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(25)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(26)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(27)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(28)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(29)),
	HOST_HANDLED(SYS_PMEVTYPERn_EL0(30)),
	HOST_HANDLED(SYS_PMCCFILTR_EL0),
};
